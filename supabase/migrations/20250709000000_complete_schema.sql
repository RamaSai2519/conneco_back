-- Complete schema migration - combines all previous migrations
-- This replaces:
-- - 20250702163947_create_users_table.sql
-- - 20250702170434_create_posts_table.sql  
-- - 20250703000000_add_date_to_posts.sql
-- - 20250709000000_refactor_posts_structure.sql
